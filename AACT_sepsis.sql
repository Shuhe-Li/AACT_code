with 
	cond as (select distinct nct_id, downcase_name from ctgov.conditions where 
		downcase_name like '%sepsis%' or downcase_name like '%septic%' or downcase_name like '%bacteremia%' or 
		downcase_name like '%fungemia%' or downcase_name like '%parasitemia%' or downcase_name like '%viremia%' or
		downcase_name like '%poisoning%blood%' or downcase_name like '%blood%poisoning%' or downcase_name like '%shock%toxic%' or
		downcase_name like '%toxic%shock%' or downcase_name like '%endotoxic%'),
